...
import GaleriaJogo from '../SlideMobile/GaleriaJogo'
...
function ContainerJogo() {
   ...
   // Função para trocar as informações do Slide //
   ...
   // Função para mudar informações do slide de acordo com o jogo // 
   ...
   return (
      ...
      <section className={styles.containerJogo}>
         <div className={styles.coluna1Mobile}>
         ...
         <div className={styles.coluna1}>
            ...
            <a target="_blank" href={ingresso} id={styles.btnSlide}>INGRESSO</a>
         </div>
